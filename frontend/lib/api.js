...
export const customerAPI = {
  ...
  uploadAvatar: (formData) => api.post('/api/customers/upload-asset', formData, {
    headers: { 'Content-Type': 'multipart/form-data' },
  }),
...
export const dmsAPI = {
  ...
  aiReply: (id, tone, savePending) => api.post(`/api/dms/${id}/ai-reply`, { tone, savePending }),
  approveDraft: (id, editedText) => api.post(`/api/dms/${id}/draft/approve`, { editedText }),
  dismissDraft: (id) => api.post(`/api/dms/${id}/draft/dismiss`),

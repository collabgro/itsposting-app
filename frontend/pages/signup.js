...
const INDUSTRIES = ['Concrete & Masonry', 'Plumbing', 'HVAC', 'Landscaping', 'Roofing', 'Electrical', 'Painting', 'Carpentry', 'General Contracting', 'Other'];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({ email: formData.email, password: formData.password, businessName: formData.businessName, industry: formData.industry.toLowerCase().replace(/\s+&\s+/g, '_'), location: formData.location }),
      });

...
const industryKnowledge = {
  ...
  hvac: {
    ...
    imageVisuals: {
      keyElements: ['outdoor condenser unit', 'manifold refrigerant gauges', 'dirty vs. clean air filter side-by-side', 'furnace burner flames', 'ductwork with mastic sealant', 'digital thermostat display', 'blower motor assembly', 'heat pump unit'],
      authenticScenes: ['technician crouching at outdoor condenser unit with gauges attached', 'dirty filter vs. clean filter held side-by-side', 'new system installation with technician connecting refrigerant lines', 'ductwork sealing in attic or crawlspace', 'before/after of disorganized vs. organized equipment room'],
      avoidCliches: ['cartoon snowflake and sun icons', 'generic house illustration with temperature arrows', 'clipart thermostat', 'stock photo of person adjusting wall thermostat in clean home'],
      colorPalette: 'silver and gray metal units, blue refrigerant gauge dials, orange furnace flame, white air filter, copper refrigerant tubing',
      composition: 'technician actively working at outdoor unit (kneeling, tools out), dramatic dirty vs. clean filter comparison, new equipment installation wide shot showing the full system',
      seasonalVisuals: {
        winter: 'technician servicing furnace during snowstorm with warm interior contrast, frost on outdoor unit',
        spring: 'AC startup with gauges attached, outdoor unit being cleaned with hose, first cooling season prep',
        summer: 'technician at outdoor condenser in heat haze, thermostat showing cool temperature against hot exterior',
        fall: 'furnace inspection with technician checking burner, dirty filter removal before heating season starts',
      },
    },
  },

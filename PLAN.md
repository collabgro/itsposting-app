...
**Feature:** Export a monthly performance report for clients or personal review.

1. Analytics page: "Export Report" button
2. Date range picker
3. Report contents: post count, reach, engagement, best 3 posts, content mix chart, AI Visibility score
4. PDF generated server-side (puppeteer or @react-pdf/renderer)
5. Branded with ItsPosting (and optionally client's business name/logo)
6. Also: "Email this report" option → sends to any email address
...
### 6.1 Public Landing Page (itsposting.com integration)

**Context:** User has itsposting.com for marketing. That website should reflect the app's quality.

**Key pages needed on the marketing site:**
1. `/` — Hero + how it works + pricing + testimonials + FAQ
2. `/features` — Deep dive on each feature
3. `/industries/[industry]` — SEO pages per trade: "Social media for plumbers", etc.
4. `/pricing` — Detailed plan comparison
5. `/blog` — Industry-specific content for SEO
6. `/showcase` — Gallery of AI-generated posts (public, from app)
7. `/affiliate` — Affiliate program
8. `/developers` — API documentation

**Hero copy:**
- Headline: "Your AI Social Media Manager — Built for Local Trades"
- Sub: "PostCore knows your season, your industry, your location. First post in 60 seconds."
- CTA: "Start free — no credit card needed"
- Social proof: "1,200+ plumbers, HVAC companies, and roofers trust ItsPosting"

**Viral mechanic:** The showcase page on itsposting.com features real posts generated by users.
"This post got 847 views on Google Business. Made in 60 seconds. Try it free →"

### 6.2 SEO Strategy — Industry pages

**Target keywords (high commercial intent, low competition):**
- "social media posts for plumbers" → `/industries/plumbing`
- "HVAC social media ideas" → `/industries/hvac`
- "roofing company social media" → `/industries/roofing`
- "AI social media for local businesses" → homepage
- "social media automation for contractors" → `/features/automation`

**Each industry page:**
- Shows actual generated post examples from that industry
- Explains seasonal content calendar for that trade
- "Generate your first [plumbing/roofing/HVAC] post free →" CTA
...
──────────────────────────
Complete all → earn 10 bonus credits
```

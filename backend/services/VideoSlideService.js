...
class VideoSlideService {
  ...
  _problemScene(industry, loc) {
    const scenes = {
      ...
      hvac:               `Homeowner sweating indoors, thermostat showing high temperature, struggling AC unit visible outside in ${loc}.`,
      roofing:            `Damaged roof with missing shingles and dark water-stain streaks, storm damage visible from street in ${loc}.`,
      concrete:           `Cracked heaved driveway with weeds growing in gaps, hazardous uneven surfaces in ${loc}.`,
      landscaping:        `Overgrown neglected yard with patchy dead lawn and tangled weeds, terrible curb appeal in ${loc}.`,
      electrical:         `Flickering light fixture and outdated breaker panel with visible hazards, concerned homeowner in ${loc}.`,
      painting:           `Peeling faded exterior paint, worn chipped surfaces, tired aged appearance on ${loc} home.`,
      pest_control:       `Homeowner discovering pest evidence in kitchen cabinet, disgusted expression, clear infestation signs in ${loc}.`,
      cleaning:           `Very dirty kitchen with grease-covered stovetop and grimy countertops before professional cleaning in ${loc}.`,
      general_contractor: `Outdated worn-out kitchen with cracked countertops and old cabinets, homeowner pointing at problems in ${loc}.`,
      tree_service:       `Massive dead tree leaning dangerously toward house after storm, homeowner looking worried from window in ${loc}.`,
      pressure_washing:   `Green-black mold and years of grime on driveway and siding, neglected exterior of ${loc} home.`,
      pool_spa:           `Murky green algae-filled pool water, neglected equipment, dirty pool deck in ${loc} backyard.`,
      handyman:           `Leaning broken fence, stuck door that won't close, and sagging gutter, multiple ignored problems at ${loc} home.`,
      flooring:           `Scratched worn-out carpet and cracked old tile, dated appearance making room look small and tired in ${loc}.`,
      junk_removal:       `Garage packed floor-to-ceiling with clutter and old furniture, barely walkable, overwhelming mess in ${loc}.`,
      solar:              `Homeowner staring at high electricity bill at kitchen table, frustrated expression, bill clearly visible.`,
      gutter_cleaning:    `Overflowing gutters packed with leaves, water pouring over edge, fascia water damage on ${loc} home.`,
    };
  ...
  _workScene(industry) {
    const scenes = {
      ...
      roofing:            `Roofing crew installing new shingles in steady teamwork rhythm, safety harnesses on, blue sky above.`,
      concrete:           `Concrete crew screeding fresh pour across driveway, precision teamwork, smooth rhythmic motion, bright day.`,
      ...
      painting:           `Professional painter rolling vibrant fresh paint across wall in smooth even strokes, crisp tape lines.`,
      pest_control:       `Pest control technician in uniform methodically applying professional treatment around home perimeter.`,
      cleaning:           `Professional cleaning team working efficiently surface by surface, gleaming results appearing instantly.`,
      general_contractor: `Contractor crew installing new kitchen cabinets and countertops in precise teamwork, measuring and fitting.`,
      tree_service:       `Certified arborist in full harness climbing tall tree with chainsaw, professional safety equipment, confident.`,
      pressure_washing:   `Pressure washer operator directing high-pressure spray across grimy driveway, dramatic instant clean line visible.`,
      pool_spa:           `Pool technician testing water chemistry with professional kit and brushing algae from pool walls, systematic.`,
      handyman:           `Skilled handyman repairing fence post with level, drill, and fresh lumber, clean organized workspace.`,
      flooring:           `Flooring installer placing hardwood planks with precision, mallet and spacers in use, expert technique visible.`,
      junk_removal:       `Junk removal crew efficiently loading heavy items onto truck in fast organized teamwork, quick pace.`,
      solar:              `Solar installation team carefully mounting photovoltaic panels on roof in neat rows, safety gear on.`,
      gutter_cleaning:    `Technician on ladder clearing packed gutters with professional scoop tool, debris falling, systematic progress.`,
    };
  ...
  _resultScene(industry, loc) {
    const scenes = {
      plumbing:           `Gleaming dry cabinet under sink with new pipe installed, no leaks, relieved homeowner smiling in ${loc}.`,
      hvac:               `Comfortable cool home with thermostat set perfectly, homeowner relaxing and smiling with relief in ${loc}.`,
      roofing:            `Brand new pristine roof gleaming in sunlight, perfect shingles, clean gutters, curb appeal restored in ${loc}.`,
      concrete:           `Flawless smooth new driveway with perfect finish, incredible transformation, stunning result in ${loc}.`,
      landscaping:        `Immaculate manicured lawn and beautiful garden beds, stunning curb appeal, property transformed in ${loc}.`,
      electrical:         `Modern clean electrical panel, bright reliable lights throughout home, safe and fully upgraded in ${loc}.`,
      painting:           `Beautifully painted home with rich fresh color, sharp clean lines, stunning transformation in ${loc}.`,
      pest_control:       `Clean pest-free home, family relaxing comfortably on couch, complete peace of mind restored in ${loc}.`,
      cleaning:           `Spotlessly clean sparkling home, every surface gleaming, homeowner delighted and amazed in ${loc}.`,
      general_contractor: `Stunning renovated kitchen with new cabinets, countertops, and fixtures, homeowner arms wide open in ${loc}.`,
      tree_service:       `Clear safe yard with fresh wood chips where the tree was, homeowner relieved and smiling in ${loc}.`,
      pressure_washing:   `Gleaming like-new driveway and siding, dramatic before/after contrast visible, homeowner proud in ${loc}.`,
      pool_spa:           `Crystal clear sparkling blue pool in sunlit backyard, family relaxing poolside, perfect water in ${loc}.`,
      handyman:           `Straight solid fence, properly hung door, and clean gutters — everything fixed, homeowner delighted in ${loc}.`,
      flooring:           `Gorgeous new hardwood floor with light reflecting off clean surface, room completely transformed in ${loc}.`,
      junk_removal:       `Completely empty clean garage, open usable space, homeowner arms wide showing the transformation in ${loc}.`,
      solar:              `Gleaming solar panels on roof in bright sunlight, homeowner checking savings app with huge smile in ${loc}.`,
      gutter_cleaning:    `Clean empty gutters, water flowing smoothly through downspout, fascia protected, homeowner satisfied in ${loc}.`,
    };
